...
proc create_root_design { parentCell } {
  ...
  set sw2shield_scl_o_out [ create_bd_port -dir O -from 0 -to 0 sw2shield_scl_o_out ]
  set sw2shield_scl_t_out [ create_bd_port -dir O -from 0 -to 0 sw2shield_scl_t_out ]
  set sw2shield_sda_o_out [ create_bd_port -dir O -from 0 -to 0 sw2shield_sda_o_out ]
  set sw2shield_sda_t_out [ create_bd_port -dir O -from 0 -to 0 sw2shield_sda_t_out ]
...
CONFIG.SINGLE_PORT_BRAM {1} \
  ...
  # Create instance: mb_bram_ctrl_1_bram, and set properties
  set mb_bram_ctrl_1_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 mb_bram_ctrl_1_bram ]
  set_property -dict [ list \
...
CONFIG.SINGLE_PORT_BRAM {1} \
  ...
  # Create instance: mb_bram_ctrl_2_bram, and set properties
  set mb_bram_ctrl_2_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 mb_bram_ctrl_2_bram ]
  set_property -dict [ list \
CONFIG.use_bram_block {BRAM_Controller} \
 ] $mb_bram_ctrl_2_bram
...
CONFIG.CONST_WIDTH {6} \
  ...
  connect_bd_intf_net -intf_net mb_bram_ctrl_1_BRAM_PORTA [get_bd_intf_pins mb_bram_ctrl_1/BRAM_PORTA] [get_bd_intf_pins mb_bram_ctrl_1_bram/BRAM_PORTA]
  connect_bd_intf_net -intf_net mb_bram_ctrl_2_BRAM_PORTA [get_bd_intf_pins mb_bram_ctrl_2/BRAM_PORTA] [get_bd_intf_pins mb_bram_ctrl_2_bram/BRAM_PORTA]
  ...
  connect_bd_net -net logic_1_dout [get_bd_pins concat_interrupts/In2] [get_bd_pins logic_1/dout]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins processing_system7_0/FCLK_CLK3] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0_axi_periph/S01_ACLK] [get_bd_pins rst_processing_system7_0_166M/slowest_sync_clk]
  ...
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins audio_path_sel/Din] [get_bd_pins processing_system7_0/GPIO_O]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins concat_interrupts/In1] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_10_dout [get_bd_ports sw2shield_scl_t_out] [get_bd_pins xlconstant_10/dout]
  connect_bd_net -net xlconstant_11_dout [get_bd_ports sw2shield_scl_o_out] [get_bd_pins xlconstant_11/dout]
  connect_bd_net -net xlconstant_12_dout [get_bd_ports sw2shield_data_out_d13_d2] [get_bd_pins xlconstant_12/dout]
  connect_bd_net -net xlconstant_13_dout [get_bd_ports sw2shield_data_out_d1_d0] [get_bd_pins xlconstant_13/dout]
  connect_bd_net -net xlconstant_14_dout [get_bd_ports sw2shield_data_out_a5_a0] [get_bd_pins xlconstant_14/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_ports sw2shield_tri_out_d13_d2] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_ports sw2shield_tri_out_d1_d0] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_ports sw2shield_tri_out_a5_a0] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_ports pmodJA_tri_out] [get_bd_pins xlconstant_4/dout]
  connect_bd_net -net xlconstant_5_dout [get_bd_ports pmodJB_tri_out] [get_bd_pins xlconstant_5/dout]
  connect_bd_net -net xlconstant_6_dout [get_bd_ports pmodJA_data_out] [get_bd_pins xlconstant_6/dout]
  connect_bd_net -net xlconstant_7_dout [get_bd_ports pmodJB_data_out] [get_bd_pins xlconstant_7/dout]
  connect_bd_net -net xlconstant_8_dout [get_bd_ports sw2shield_sda_t_out] [get_bd_pins xlconstant_8/dout]
  connect_bd_net -net xlconstant_9_dout [get_bd_ports sw2shield_sda_o_out] [get_bd_pins xlconstant_9/dout]
...
#  -string -flagsOSRD
preplace port btns_4bits -pg 1 -y 1060 -defaultsOSRD
preplace port DDR -pg 1 -y 90 -defaultsOSRD
preplace port shield2sw_scl_i_in -pg 1 -y 120 -defaultsOSRD
preplace port hdmi_out_ddc -pg 1 -y 130 -defaultsOSRD
preplace port shield2sw_sda_i_in -pg 1 -y 140 -defaultsOSRD
preplace port leds_4bits -pg 1 -y 1360 -defaultsOSRD
preplace port hdmi_out -pg 1 -y 660 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 110 -defaultsOSRD
preplace port sws_2bits -pg 1 -y 1340 -defaultsOSRD
preplace port hdmi_in -pg 1 -y 610 -defaultsOSRD
preplace port rgbleds_6bits -pg 1 -y 1480 -defaultsOSRD
preplace port hdmi_in_ddc -pg 1 -y 620 -defaultsOSRD
preplace port pdm_m_data_i -pg 1 -y 1790 -defaultsOSRD
preplace portBus pmodJA_tri_out -pg 1 -y 1950 -defaultsOSRD
preplace portBus pmodJB_tri_out -pg 1 -y 2040 -defaultsOSRD
preplace portBus sw2shield_data_out_a5_a0 -pg 1 -y 2850 -defaultsOSRD
preplace portBus sw2shield_scl_o_out -pg 1 -y 2580 -defaultsOSRD
preplace portBus shield2sw_data_in_d1_d0 -pg 1 -y 80 -defaultsOSRD
preplace portBus pdm_m_clk -pg 1 -y 1210 -defaultsOSRD
preplace portBus pmodJB_data_out -pg 1 -y 2220 -defaultsOSRD
preplace portBus sw2shield_sda_o_out -pg 1 -y 2400 -defaultsOSRD
preplace portBus pwm_audio_o -pg 1 -y 1230 -defaultsOSRD
preplace portBus sw2shield_tri_out_d13_d2 -pg 1 -y 1680 -defaultsOSRD
preplace portBus pmodJB_data_in -pg 1 -y 40 -defaultsOSRD
preplace portBus sw2shield_scl_t_out -pg 1 -y 2490 -defaultsOSRD
preplace portBus sw2shield_data_out_d1_d0 -pg 1 -y 2760 -defaultsOSRD
preplace portBus shield2sw_data_in_a5_a0 -pg 1 -y 60 -defaultsOSRD
preplace portBus sw2shield_data_out_d13_d2 -pg 1 -y 2670 -defaultsOSRD
preplace portBus hdmi_out_hpd -pg 1 -y 740 -defaultsOSRD
preplace portBus pdm_audio_shutdown -pg 1 -y 1190 -defaultsOSRD
preplace portBus sw2shield_tri_out_a5_a0 -pg 1 -y 1860 -defaultsOSRD
preplace portBus shield2sw_data_in_d13_d2 -pg 1 -y 100 -defaultsOSRD
preplace portBus pmodJA_data_out -pg 1 -y 2130 -defaultsOSRD
preplace portBus pmodJA_data_in -pg 1 -y 20 -defaultsOSRD
preplace portBus sw2shield_tri_out_d1_d0 -pg 1 -y 1770 -defaultsOSRD
preplace portBus sw2shield_sda_t_out -pg 1 -y 2310 -defaultsOSRD
preplace portBus hdmi_in_hpd -pg 1 -y 760 -defaultsOSRD
preplace inst xlconstant_11 -pg 1 -lvl 4 -y 2580 -defaultsOSRD
preplace inst xlconstant_12 -pg 1 -lvl 4 -y 2670 -defaultsOSRD
preplace inst rst_processing_system7_0_166M -pg 1 -lvl 1 -y 1350 -defaultsOSRD
preplace inst mb_bram_ctrl_2_bram -pg 1 -lvl 4 -y 950 -defaultsOSRD
preplace inst xlconstant_13 -pg 1 -lvl 4 -y 2760 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 2 -y 1650 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 510 -defaultsOSRD
preplace inst xlconstant_14 -pg 1 -lvl 4 -y 2850 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 4 -y 1680 -defaultsOSRD
preplace inst swsleds_gpio -pg 1 -lvl 4 -y 1350 -defaultsOSRD
preplace inst proc_sys_reset_pixelclk -pg 1 -lvl 2 -y 300 -defaultsOSRD
preplace inst proc_sys_reset_142M -pg 1 -lvl 2 -y 120 -defaultsOSRD
preplace inst audio -pg 1 -lvl 4 -y 1210 -defaultsOSRD
preplace inst xlconstant_2 -pg 1 -lvl 4 -y 1770 -defaultsOSRD
preplace inst concat_interrupts -pg 1 -lvl 3 -y 1720 -defaultsOSRD
preplace inst xlconstant_3 -pg 1 -lvl 4 -y 1860 -defaultsOSRD
preplace inst rgbleds_gpio -pg 1 -lvl 4 -y 1480 -defaultsOSRD
preplace inst logic_1 -pg 1 -lvl 2 -y 1740 -defaultsOSRD
preplace inst audio_path_sel -pg 1 -lvl 3 -y 460 -defaultsOSRD
preplace inst xlconstant_4 -pg 1 -lvl 4 -y 1950 -defaultsOSRD
preplace inst mb_bram_ctrl_1_bram -pg 1 -lvl 4 -y 860 -defaultsOSRD
preplace inst xlconstant_5 -pg 1 -lvl 4 -y 2040 -defaultsOSRD
preplace inst mb_bram_ctrl_3_bram -pg 1 -lvl 4 -y 1590 -defaultsOSRD
preplace inst xlconstant_6 -pg 1 -lvl 4 -y 2130 -defaultsOSRD
preplace inst btns_gpio -pg 1 -lvl 4 -y 1060 -defaultsOSRD
preplace inst xlconstant_7 -pg 1 -lvl 4 -y 2220 -defaultsOSRD
preplace inst mb_bram_ctrl_1 -pg 1 -lvl 3 -y 960 -defaultsOSRD
preplace inst xlconstant_8 -pg 1 -lvl 4 -y 2310 -defaultsOSRD
preplace inst video -pg 1 -lvl 3 -y 690 -defaultsOSRD
preplace inst mb_bram_ctrl_2 -pg 1 -lvl 3 -y 1100 -defaultsOSRD
preplace inst xlconstant_9 -pg 1 -lvl 4 -y 2400 -defaultsOSRD
preplace inst mb_bram_ctrl_3 -pg 1 -lvl 3 -y 1590 -defaultsOSRD
preplace inst xlconstant_10 -pg 1 -lvl 4 -y 2490 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 2 -y 1080 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 4 -y 170 -defaultsOSRD
preplace netloc xlconstant_4_dout 1 4 1 NJ
preplace netloc pdm_m_clk_mux_y 1 4 1 NJ
preplace netloc video_dout 1 2 2 970 1470 1270
preplace netloc pdm_audio_shutdown_mux_y 1 4 1 NJ
preplace netloc xlconstant_11_dout 1 4 1 NJ
preplace netloc xlconstant_13_dout 1 4 1 NJ
preplace netloc processing_system7_0_FIXED_IO 1 4 1 NJ
preplace netloc swsleds_gpio_GPIO2 1 4 1 NJ
preplace netloc video_aPixelClkLckd 1 1 3 420 670 NJ 880 1280
preplace netloc xlconstant_3_dout 1 4 1 NJ
preplace netloc hdmi_in_1 1 0 3 NJ 610 NJ 610 NJ
preplace netloc concat_interrupts_dout 1 3 1 1310
preplace netloc proc_sys_reset_0_peripheral_reset 1 2 1 920
preplace netloc xlconstant_12_dout 1 4 1 NJ
preplace netloc mb_bram_ctrl_2_BRAM_PORTA 1 3 1 NJ
preplace netloc S_AXI_LITE_1 1 2 1 880
preplace netloc mb_bram_ctrl_3_BRAM_PORTA 1 3 1 NJ
preplace netloc processing_system7_0_DDR 1 4 1 NJ
preplace netloc dvi2rgb_0_DDC 1 3 2 NJ 620 NJ
preplace netloc xlconstant_14_dout 1 4 1 NJ
preplace netloc xlconstant_5_dout 1 4 1 NJ
preplace netloc xlconstant_1_dout 1 4 1 NJ
preplace netloc hdmi_out_hpd_video_gpio_io_o 1 3 2 NJ 740 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 5 20 350 370 210 NJ 360 NJ 380 1790
preplace netloc S_AXI1_1 1 2 1 840
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 2 1 910
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 2 1 870
preplace netloc xlconstant_8_dout 1 4 1 NJ
preplace netloc processing_system7_0_axi_periph_M03_AXI 1 2 1 810
preplace netloc mb_bram_ctrl_1_BRAM_PORTA 1 3 1 NJ
preplace netloc proc_sys_reset_142M_interconnect_aresetn 1 2 1 950
preplace netloc rst_processing_system7_0_166M_peripheral_aresetn 1 1 1 N
preplace netloc xlconstant_10_dout 1 4 1 NJ
preplace netloc rgbled_gpio_GPIO 1 4 1 NJ
preplace netloc processing_system7_0_axi_periph_M11_AXI 1 2 2 NJ 1170 N
preplace netloc xlconstant_2_dout 1 4 1 NJ
preplace netloc ctrl_1 1 2 1 860
preplace netloc processing_system7_0_IIC_0 1 4 1 NJ
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 2 2 NJ 1030 1280
preplace netloc processing_system7_0_axi_periph_M12_AXI 1 2 2 780 1460 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 5 30 600 370 660 820 1190 1330 340 1800
preplace netloc pdm_m_data_i_1 1 0 4 NJ 1790 NJ 1790 NJ 1790 NJ
preplace netloc processing_system7_0_FCLK_CLK1 1 1 4 420 20 960 200 1350 370 1810
preplace netloc video_PixelClk 1 1 3 410 410 NJ 410 1270
preplace netloc processing_system7_0_FCLK_CLK2 1 2 3 970 890 NJ 810 1830
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 1 390
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 2 2 NJ 1180 1280
preplace netloc processing_system7_0_FCLK_CLK3 1 0 5 30 1260 400 30 NJ 30 1340 360 1780
preplace netloc pwm_audio_o_mux_y 1 4 1 NJ
preplace netloc S_AXI_1 1 2 1 800
preplace netloc ctrl1_1 1 2 1 900
preplace netloc xlconstant_9_dout 1 4 1 NJ
preplace netloc xlconstant_6_dout 1 4 1 NJ
preplace netloc axi_gpio_video_gpio_io_o 1 3 2 NJ 760 NJ
preplace netloc audio_path_sel_Dout 1 3 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 4 430 390 NJ 390 NJ 390 1850
preplace netloc processing_system7_0_M_AXI_GP1 1 1 4 440 400 NJ 400 NJ 400 1840
preplace netloc proc_sys_reset_142M_peripheral_aresetn 1 2 1 930
preplace netloc logic_1_dout 1 2 1 NJ
preplace netloc xlconstant_0_dout 1 2 1 NJ
preplace netloc axi_mem_intercon_M00_AXI 1 3 1 1280
preplace netloc processing_system7_0_GPIO_O 1 2 3 970 350 NJ 350 1820
preplace netloc processing_system7_0_axi_periph_M04_AXI 1 2 1 790
preplace netloc swsleds_gpio_GPIO 1 4 1 NJ
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 3 380 1490 950 1200 1350
preplace netloc btns_gpio_GPIO 1 4 1 NJ
preplace netloc video_TMDS1 1 3 2 NJ 660 NJ
preplace netloc s00_axi_1 1 2 1 890
preplace netloc xlconstant_7_dout 1 4 1 NJ
levelinfo -pg 1 0 200 610 1120 1570 1870 -top 0 -bot 2900
",
}
