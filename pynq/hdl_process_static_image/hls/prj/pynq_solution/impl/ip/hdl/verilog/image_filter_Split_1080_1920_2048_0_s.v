...
module image_filter_Split_1080_1920_2048_0_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_sig_102;
wire   [10:0] j_V_fu_144_p2;
reg   [10:0] p_i_reg_106;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == exitcond1_i_fu_128_p2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_102) & ~(1'b0 == exitcond_i_fu_139_p2))) begin
            ap_reg_ppiten_pp0_it0 <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (1'b0 == exitcond1_i_fu_128_p2))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (1'b0 == exitcond1_i_fu_128_p2)) | ((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_102) & ~(1'b0 == exitcond_i_fu_139_p2)))) begin
            ap_reg_ppiten_pp0_it1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (1'b1 == ap_reg_ppiten_pp0_it0) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_102) & (1'b0 == exitcond_i_fu_139_p2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_102))) begin
...
always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == exitcond1_i_fu_128_p2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == exitcond1_i_fu_128_p2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (1'b1 == ap_reg_ppiten_pp0_it1) & (exitcond_i_reg_169 == 1'b0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (1'b1 == ap_reg_ppiten_pp0_it1) & (exitcond_i_reg_169 == 1'b0) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_102))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st2_fsm_1 : begin
            if (~(1'b0 == exitcond1_i_fu_128_p2)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else begin
        ...
        ap_ST_pp0_stg0_fsm_2 : begin
            if (~((1'b1 == ap_reg_ppiten_pp0_it0) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_102) & ~(1'b0 == exitcond_i_fu_139_p2))) begin
                ap_NS_fsm = ap_ST_pp0_stg0_fsm_2;
            end else if (((1'b1 == ap_reg_ppiten_pp0_it0) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_102) & ~(1'b0 == exitcond_i_fu_139_p2))) begin
...
always @ (*) begin
    ap_sig_102 = (((exitcond_i_reg_169 == 1'b0) & (src_data_stream_0_V_empty_n == 1'b0)) | ((exitcond_i_reg_169 == 1'b0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_i_reg_169 == 1'b0) & (dst0_data_stream_V_full_n == 1'b0)) | ((exitcond_i_reg_169 == 1'b0) & (dst1_data_stream_V_full_n == 1'b0)));
end
...
assign exitcond1_i_fu_128_p2 = ((p_i_reg_106 == rows) ? 1'b1 : 1'b0);

assign exitcond_i_fu_139_p2 = ((p_1_i_reg_117 == cols) ? 1'b1 : 1'b0);

assign i_V_fu_133_p2 = (p_i_reg_106 + ap_const_lv11_1);

assign j_V_fu_144_p2 = (p_1_i_reg_117 + ap_const_lv11_1);

endmodule //image_filter_Split_1080_1920_2048_0_s
