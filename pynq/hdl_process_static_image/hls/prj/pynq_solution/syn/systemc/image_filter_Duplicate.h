...
#ifndef _image_filter_Duplicate_HH_
#define _image_filter_Duplicate_HH_
...
struct image_filter_Duplicate : public sc_module {
    ...
    // Module declarations
    image_filter_Duplicate(sc_module_name name);
    SC_HAS_PROCESS(image_filter_Duplicate);

    ~image_filter_Duplicate();
    ...
    sc_signal< sc_lv<11> > p_6_i_reg_137;
    sc_signal< bool > ap_sig_84;
    sc_signal< sc_lv<1> > exitcond1_i_fu_148_p2;
    sc_signal< sc_logic > ap_sig_cseq_ST_st2_fsm_1;
    sc_signal< bool > ap_sig_96;
    sc_signal< sc_lv<11> > i_V_fu_153_p2;
    sc_signal< sc_lv<11> > i_V_reg_184;
    sc_signal< sc_lv<1> > exitcond_i_fu_159_p2;
    sc_signal< bool > ap_sig_118;
    sc_signal< sc_lv<11> > j_V_fu_164_p2;
    sc_signal< sc_lv<11> > p_i_reg_126;
    ...
    void thread_exitcond1_i_fu_148_p2();
    void thread_exitcond_i_fu_159_p2();
    void thread_i_V_fu_153_p2();
