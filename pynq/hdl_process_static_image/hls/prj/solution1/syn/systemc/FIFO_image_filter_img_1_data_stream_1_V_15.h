...
#ifndef FIFO_image_filter_img_1_data_stream_1_V_15_HH_
#define FIFO_image_filter_img_1_data_stream_1_V_15_HH_

#include <systemc>
using namespace std;
SC_MODULE(FIFO_image_filter_img_1_data_stream_1_V_15) {
    static const unsigned int DATA_WIDTH = 8;
    static const unsigned int ADDR_WIDTH = 15;
    static const unsigned int FIFO_image_filter_img_1_data_stream_1_V_15_depth = 20001;
    ...
    sc_core::sc_signal< sc_dt::sc_lv<DATA_WIDTH> >  mStorage[FIFO_image_filter_img_1_data_stream_1_V_15_depth];
    ...
    SC_CTOR(FIFO_image_filter_img_1_data_stream_1_V_15) : mTrace(0) {
        ...
        SC_METHOD(proc_dout);
        sensitive << mOutPtr;
        for (unsigned i = 0; i < FIFO_image_filter_img_1_data_stream_1_V_15_depth; i++) {
    ...
    ~FIFO_image_filter_img_1_data_stream_1_V_15() {
        ...
        if (reset.read() == sc_dt::SC_LOGIC_1) {
            ...
            if (if_read_ce.read() == sc_dt::SC_LOGIC_1
               ...
               && internal_empty_n.read() == sc_dt::SC_LOGIC_1) {
                ...
                if (mOutPtr.read().to_uint() == (FIFO_image_filter_img_1_data_stream_1_V_15_depth-1)) {
                    ptr = 0;
                ...
                assert(ptr.to_uint() < FIFO_image_filter_img_1_data_stream_1_V_15_depth);
                mOutPtr.write(ptr);
            }
            if (if_write_ce.read() == sc_dt::SC_LOGIC_1
                ...
                if (ptr.to_uint() == (FIFO_image_filter_img_1_data_stream_1_V_15_depth-1)) {
                    ptr = 0;
                    mFlag_nEF_hint.write(~mFlag_nEF_hint.read());
                } else {
                    ptr++;
    ...
    void proc_dout() {
        ...
        if (ptr.to_uint() > FIFO_image_filter_img_1_data_stream_1_V_15_depth) {
...
#endif //FIFO_image_filter_img_1_data_stream_1_V_15_HH_
