; ModuleID = '/home/cospan/Projects/xilinx_projects/hdl-image-processing/hls/simple_image_process/solution1/.autopilot/db/a.o.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@simple.shift_reg = internal global [11 x i32] zeroinitializer, align 16 ; [#uses=4 type=[11 x i32]*]
@.str = private unnamed_addr constant [17 x i8] c"Shift_Accum_Loop\00", align 1 ; [#uses=1 type=[17 x i8]*]

; [#uses=0]
define void @simple(i32* %y, i32* %c, i32 %x) nounwind uwtable {
...
; <label>:12                                      ; preds = %9
  ...
  store i32 %13, i32* getelementptr inbounds ([11 x i32]* @simple.shift_reg, i32 0, i64 0), align 4, !dbg !50 ; [debug line = 62:4]
...
; <label>:15                                      ; preds = %9
  ...
  %19 = getelementptr inbounds [11 x i32]* @simple.shift_reg, i32 0, i64 %18, !dbg !54 ; [#uses=1 type=i32*] [debug line = 65:4]
  ...
  %23 = getelementptr inbounds [11 x i32]* @simple.shift_reg, i32 0, i64 %22, !dbg !54 ; [#uses=1 type=i32*] [debug line = 65:4]
  ...
  %26 = getelementptr inbounds [11 x i32]* @simple.shift_reg, i32 0, i64 %25, !dbg !56 ; [#uses=1 type=i32*] [debug line = 66:4]
...
!0 = metadata !{i32 786449, i32 0, i32 1, metadata !"/home/cospan/Projects/xilinx_projects/hdl-image-processing/hls/simple_image_process/solution1/.autopilot/db/simple.pragma.2.c", metadata !"/home/cospan/Projects/xilinx_projects/hdl-image-processing/hls", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !16} ; [ DW_TAG_compile_unit ]
!1 = metadata !{metadata !2}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{metadata !5}
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"simple", metadata !"simple", metadata !"", metadata !6, i32 48, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*, i32*, i32)* @simple, null, null, metadata !14, i32 52} ; [ DW_TAG_subprogram ]
!6 = metadata !{i32 786473, metadata !"simple_image_process/src/simple.c", metadata !"/home/cospan/Projects/xilinx_projects/hdl-image-processing/hls", null} ; [ DW_TAG_file_type ]
...
!18 = metadata !{i32 786484, i32 0, metadata !5, metadata !"shift_reg", metadata !"shift_reg", metadata !"", metadata !6, i32 54, metadata !19, i32 1, i32 1, [11 x i32]* @simple.shift_reg} ; [ DW_TAG_variable ]
...
!22 = metadata !{void (i32*, i32*, i32)* @simple, metadata !23, metadata !24, metadata !25, metadata !26, metadata !27, metadata !28}
