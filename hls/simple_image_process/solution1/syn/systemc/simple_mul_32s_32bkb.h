...
#ifndef __simple_mul_32s_32bkb__HH__
#define __simple_mul_32s_32bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(simple_mul_32s_32bkb) {
    ...
    SC_CTOR(simple_mul_32s_32bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
